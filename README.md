# Web Development Final Project - *Foodie Forum* 🍜

Submitted by: **Deborah Oladokun**

This web app: **Lets users discuss food and post recipes!**
...
* [x] Responsive layout optimized for desktop and mobile devices
